...
public class ItemQuest
{
	...
	public void Init(QUESTITEMINDEX _index, int _star, string _mainName, string _mainExplan, string _subExplan, int _mainValue, string _subOptionType, int _subOptionValue, int _maxBreakThrough)
	{
